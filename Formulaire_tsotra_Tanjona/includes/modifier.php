    ...
    <div class="card p-4" style="width: 100%; max-width: 400px;">
        ...
        <div class="form-group">
            ...
            <div>
                ...
                <label for="cvFile" class="form-label mt-4">CV upload</label>
                <input class="form-control" name="NewCV" type="file" id="cvFile" accept=".pdf,.doc,.docx">
            </div>
            <div>
                <label for="photoFile" class="form-label mt-4">Photo</label>
                
                <input class="form-control" name="NewPicture" type="file" id="photoFile" accept=".jpg,.jpeg,.png">
            </div>
           
            <button type="submit" class="btn btn-primary w-100" name="submit" value="Update" style="margin: 21px 10px 10px 10px;">Supprimer mon profil</button>
        </form>
    </div>
</div>
